...
| [0042](./0042-unified-login-and-membership-based-context-selection.md) | Unified Login and Membership-Based Context Selection | Approved | 2026-09-10 | Unified credential login, direct context resolution, and membership-based pending context selection |
| [0043](./0043-workflow-bpm-engine.md) | Configurable Branch-Specific Workflow and Approval Engine | Approved | 2026-09-12 | Generic workflow foundation first integrated with Procurement Purchase Orders |
...
The next available identifier after the current index is **ADR-0044**.
