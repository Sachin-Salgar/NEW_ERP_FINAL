...
class Repository implements DiscountRuleRepository { async create() { return record; } async list() { return [record]; } async get() { return record; } async resolve() { return null; } async update() { return record; } async transition() { return { ...record, status: 'PUBLISHED' as const, versionNumber: 2 }; } }
