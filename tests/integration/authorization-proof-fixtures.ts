...
export const allRemainingPermissions = [
  ...
  'purchase.requisition.submit', 'purchase.requisition.approve', 'purchase.requisition.reject',
  'purchase.requisition.cancel', 'purchase.requisition.workflow',
  'purchase.order.read', 'purchase.order.create', 'purchase.order.update',
  'purchase.order.submit', 'purchase.order.approve', 'purchase.order.reject',
  'purchase.order.cancel', 'purchase.order.workflow',
  'purchase.receipt.read', 'purchase.receipt.create', 'purchase.receipt.update',
  'purchase.receipt.complete', 'purchase.receipt.cancel', 'purchase.receipt.workflow',
  'manufacturing.machine.read','manufacturing.machine.create','manufacturing.machine.update','manufacturing.machine.delete',
  'manufacturing.capability.read','manufacturing.capability.create','manufacturing.process.read','manufacturing.process.create',
