...
const warehouseColumns = `id, tenant_id AS "tenantId", 
  code, name, status, version, created_at AS "createdAt", created_by AS "createdBy",
  updated_at AS "updatedAt", updated_by AS "updatedBy"`;
const stockColumns = `id, tenant_id AS "tenantId", 
...
const reservationColumns = `id, tenant_id AS "tenantId", 
...
const movementColumns = `id, tenant_id AS "tenantId", 
  branch_id AS "branchId", financial_year_id AS "financialYearId", warehouse_id AS "warehouseId",
...
export class PostgresInventoryRepository implements InventoryRepository {
  ...
  private async ensureStock(
    client: PoolClient,
    input: { tenantId: string; branchId: string; warehouseId: string; itemId: string; actorUserId: string },
  ) {
    await client.query(
