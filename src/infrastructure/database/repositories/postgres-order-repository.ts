...
const C = `id,tenant_id AS "tenantId",branch_id AS "branchId",financial_year_id AS "financialYearId",order_number AS "orderNumber",customer_id AS "customerId",quotation_id AS "quotationId",warehouse_id AS "warehouseId",reservation_status AS "reservationStatus",status,notes,subtotal::float8 AS subtotal,discount_total::float8 AS "discountTotal",total::float8 AS total,created_at AS "createdAt",created_by AS "createdBy",updated_at AS "updatedAt",updated_by AS "updatedBy",deleted_at AS "deletedAt",deleted_by AS "deletedBy",is_deleted AS "isDeleted",version_number AS "versionNumber"`;
