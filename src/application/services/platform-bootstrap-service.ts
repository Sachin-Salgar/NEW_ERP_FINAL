import type { PlatformBootstrapRepository, ReferenceDataSummary } from '../contracts/security.js';
...
const DEFAULT_PERMISSIONS: PlatformPermissionSeed[] = [
  ...
  { moduleCode: 'tenant-configuration', resource: 'tenant', action: 'manage', scope: 'tenant', permissionKey: 'tenant.manage', displayName: 'Manage tenant configuration' },
  ...
  { moduleCode: 'security', resource: 'role', action: 'manage', scope: 'tenant', permissionKey: 'role.manage', displayName: 'Manage roles' },
  ...
  { moduleCode: 'security', resource: 'permission', action: 'manage', scope: 'tenant', permissionKey: 'permission.manage', displayName: 'Manage permissions' },
  { moduleCode: 'security', resource: 'session', action: 'manage', scope: 'tenant', permissionKey: 'session.manage', displayName: 'Manage sessions' },
];
