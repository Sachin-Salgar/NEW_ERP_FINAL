...
const DEFAULT_PERMISSIONS: PlatformPermissionSeed[] = [
  ...
  },
  {
    ...
    action: 'activate',
    scope: 'global',
    permissionKey: 'tenant.activate',
    displayName: 'Activate tenants',
  },
  {
    moduleCode: 'tenant-configuration',
    resource: 'tenant',
    action: 'deactivate',
    scope: 'global',
    permissionKey: 'tenant.deactivate',
    displayName: 'Deactivate tenants',
  },
  {
    moduleCode: 'tenant-configuration',
    resource: 'tenant',
  ...
  },
  {
    ...
    action: 'reactivate',
    scope: 'global',
    permissionKey: 'tenant.reactivate',
    displayName: 'Reactivate tenants',
  },
  {
    moduleCode: 'tenant-configuration',
    ...
    displayName: 'View tenant members',
  },
  {
    moduleCode: 'tenant-configuration',
    resource: 'tenant.member',
    action: 'create',
    scope: 'tenant',
    permissionKey: 'tenant.member.create',
    displayName: 'Add tenant members',
  },
  {
    moduleCode: 'tenant-configuration',
    resource: 'tenant.member',
    action: 'update',
    scope: 'tenant',
    permissionKey: 'tenant.member.update',
    displayName: 'Update tenant members',
  },
  {
    moduleCode: 'tenant-configuration',
    resource: 'tenant.member',
    action: 'delete',
    scope: 'tenant',
    permissionKey: 'tenant.member.delete',
    displayName: 'Remove tenant members',
  },
  {
    moduleCode: 'tenant-configuration',
    resource: 'tenant.member',
    action: 'activate',
    scope: 'tenant',
    permissionKey: 'tenant.member.activate',
    displayName: 'Activate tenant members',
  },
  {
    moduleCode: 'tenant-configuration',
    resource: 'tenant.member',
    action: 'deactivate',
    scope: 'tenant',
    permissionKey: 'tenant.member.deactivate',
    displayName: 'Deactivate tenant members',
  },
  {
    moduleCode: 'tenant-configuration',
    ...
    action: 'read',
    scope: 'tenant',
    permissionKey: 'tenant.access.read',
    displayName: 'View tenant access',
  },
  {
    moduleCode: 'tenant-configuration',
    resource: 'tenant.access',
    action: 'grant',
    scope: 'tenant',
    permissionKey: 'tenant.access.grant',
    displayName: 'Grant tenant access',
  },
  {
    moduleCode: 'tenant-configuration',
    resource: 'tenant.access',
    action: 'revoke',
    scope: 'tenant',
    permissionKey: 'tenant.access.revoke',
    displayName: 'Revoke tenant access',
  },
  {
  ...
  },
  {
    ...
    action: 'deactivate',
    scope: 'organization',
    permissionKey: 'organization.deactivate',
    displayName: 'Deactivate organizations',
  },
  {
    moduleCode: 'organization',
    resource: 'organization',
    action: 'activate',
    scope: 'organization',
    permissionKey: 'organization.activate',
    displayName: 'Activate organizations',
  },
  {
    moduleCode: 'organization',
    resource: 'organization',
  ...
  },
  {
    ...
    action: 'read',
    scope: 'organization',
    permissionKey: 'organization.location.read',
  ...
  },
  {
    ...
    action: 'create',
    scope: 'organization',
    permissionKey: 'organization.location.create',
  ...
  },
  {
    ...
    action: 'update',
    scope: 'organization',
    permissionKey: 'organization.location.update',
  ...
  },
  {
    ...
    action: 'deactivate',
    scope: 'organization',
    permissionKey: 'organization.location.deactivate',
    displayName: 'Deactivate locations',
  },
  {
    moduleCode: 'organization',
    resource: 'location',
    action: 'activate',
    scope: 'organization',
    permissionKey: 'organization.location.activate',
    displayName: 'Activate locations',
  },
  {
    moduleCode: 'organization',
    resource: 'location',
    action: 'delete',
    scope: 'organization',
    permissionKey: 'organization.location.delete',
  ...
  },
  {
    ...
    action: 'deactivate',
    scope: 'branch',
    permissionKey: 'branch.deactivate',
    displayName: 'Deactivate branches',
  },
  {
    moduleCode: 'branch',
    resource: 'branch',
    action: 'activate',
    scope: 'branch',
    permissionKey: 'branch.activate',
    displayName: 'Activate branches',
  },
  {
    moduleCode: 'branch',
    resource: 'branch',
  ...
  },
  {
    ...
    action: 'activate',
    scope: 'tenant',
    permissionKey: 'role.activate',
    displayName: 'Activate roles',
  },
  {
    moduleCode: 'security',
    resource: 'role',
    action: 'deactivate',
    scope: 'tenant',
    permissionKey: 'role.deactivate',
    displayName: 'Deactivate roles',
  },
  {
    moduleCode: 'security',
    ...
    action: 'read',
    scope: 'tenant',
    permissionKey: 'role_permission.read',
  ...
  },
  {
    ...
    action: 'grant',
    scope: 'tenant',
    permissionKey: 'role_permission.grant',
    displayName: 'Grant role permissions',
  },
  {
    moduleCode: 'security',
    resource: 'role_permission',
    action: 'revoke',
    scope: 'tenant',
    permissionKey: 'role_permission.revoke',
    displayName: 'Revoke role permissions',
  },
  {
    moduleCode: 'security',
    resource: 'permission',
  ...
  },
  {
    ...
    action: 'read',
    scope: 'tenant',
    permissionKey: 'security.session.read',
  ...
  },
  {
    ...
    action: 'revoke',
    scope: 'tenant',
    permissionKey: 'security.session.revoke',
  ...
  },
  {
    ...
    action: 'revoke_all',
    scope: 'tenant',
    permissionKey: 'security.session.revoke_all',
    displayName: 'Revoke all user sessions',
  },
  {
    moduleCode: 'security',
    resource: 'audit_log',
    action: 'read',
    scope: 'tenant',
    permissionKey: 'security.audit_log.read',
  ...
  },
  {
    ...
    action: 'export',
    scope: 'tenant',
    permissionKey: 'security.audit_log.export',
  ...
  },
  {
    ...
    displayName: 'View security policy',
  },
  {
    moduleCode: 'security',
    resource: 'policy',
    action: 'update',
    scope: 'tenant',
    permissionKey: 'security.policy.update',
