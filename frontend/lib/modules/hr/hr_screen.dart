...
class _HrScreenState extends State<HrScreen>{
 ...
 final tabs=<Map<String,String>>[
  {'title':'Employees','resource':'employees'},{'title':'Organization','resource':'departments'},{'title':'Attendance','resource':'attendance'},{'title':'Leave','resource':'leaveRequests'},{'title':'Payroll','resource':'payrollRuns'},{'title':'Recruitment','resource':'requisitions'},{'title':'Job Openings','resource':'jobOpenings'},{'title':'Offers','resource':'jobOffers'},{'title':'Performance','resource':'performanceCycles'},{'title':'Goals','resource':'performanceGoals'},{'title':'Training','resource':'trainingPrograms'},{'title':'Training Batches','resource':'trainingBatches'},{'title':'Training Enrollments','resource':'trainingEnrollments'},{'title':'Compliance','resource':'compliance'},{'title':'Grievances','resource':'grievances'},{'title':'Compliance Tasks','resource':'complianceTasks'},{'title':'ESS','resource':'employeeRequests'},{'title':'Payroll Settlements','resource':'payrollSettlements'},{'title':'Reports','resource':'analytics/workforce'},
 ];
 ...
 List<String> _formFields(String resource){switch(resource){case'employees':return['employee_no','first_name','middle_name','last_name','preferred_name','gender','date_of_birth','personal_email','work_email','phone','joining_date','confirmation_date','employment_type','grade','cost_center','branch_id','department_id','position_id'];case'departments':return['code','name','branch_id','parent_id'];case'attendance':return['employee_id','attendance_date','status','check_in','check_out','break_minutes','overtime_minutes','remarks'];case'leaveRequests':return['employee_id','leave_type_id','start_date','end_date','days','reason'];case'payrollRuns':return['payroll_period_id'];case'requisitions':return['requisition_no','title','department_id','position_id','vacancies','justification'];case'performanceCycles':return['code','name','start_date','end_date'];case'trainingPrograms':return['code','name','description','provider','duration_hours'];case'compliance':return['employee_id','record_type','title','due_date','details'];case'employeeRequests':return['employee_id','request_type','payload'];case'jobOpenings':return['opening_code','title','requisition_id','vacancies','open_date','close_date'];case'jobOffers':return['offer_no','application_id','offered_on','joining_date','salary','currency','status'];case'performanceGoals':return['cycle_id','employee_id','title','description','weight','target','achievement'];case'trainingBatches':return['batch_code','program_id','catalog_id','start_date','end_date','capacity','location','trainer'];case'trainingEnrollments':return['batch_id','employee_id','status'];case'grievances':return['employee_id','grievance_no','subject','details','status'];case'complianceTasks':return['employee_id','task_type','due_date','status','details'];case'payrollSettlements':return['employee_id','exit_record_id','settlement_date','earnings','deductions','net_amount','status'];default:return['code','name'];}}
