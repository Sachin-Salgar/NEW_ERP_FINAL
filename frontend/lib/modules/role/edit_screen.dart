        ...
        builder: (context, svc, _) {
          if (!auth.hasPermission('role.update'))
            return const Scaffold(
              body: Center(
                child: Text('You do not have permission to edit roles.'),
              ),
            );
                  ...
                  child: ConstrainedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        const ErpPageHeader(
                          title: 'Edit Role',
                          subtitle: 'Update role identity and configuration',
                          breadcrumbs: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  CheckboxListTile(
                                    ...
                                    subtitle: const Text(
                                      'Use only when this role is intended to be a protected system role.',
                                    ),
                                    value: _isSystem,
                                    onChanged: (v) =>
