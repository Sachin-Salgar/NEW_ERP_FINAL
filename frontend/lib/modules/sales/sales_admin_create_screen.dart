...
class SalesAdminCreateScreen extends StatefulWidget {
  final String kind;
  final String title;
  const SalesAdminCreateScreen({
    super.key,
    required this.kind,
    required this.title,
  });
  @override
  State<SalesAdminCreateScreen> createState() => _SalesAdminCreateScreenState();
}
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: ListView(
      ...
      children: [
        ...
        if (widget.kind == 'price-lists')
          TextField(
            controller: currency,
            decoration: const InputDecoration(labelText: 'Currency'),
          ),
        if (widget.kind == 'discount-rules')
          TextField(
