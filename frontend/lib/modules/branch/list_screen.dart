    ...
    return ChangeNotifierProvider<BranchService>.value(
      ...
      child: Consumer<BranchService>(
        builder: (context, svc, _) {
          ...
          if (svc.error != null)
            return _Message(message: 'Unable to load branches: ${svc.error}');
          if (!auth.hasPermission('branch.read'))
                ...
                slivers: [
                  SliverPadding(
                    ...
                    sliver: SliverToBoxAdapter(
                      child: ErpPageHeader(
                        ...
                        actions: auth.hasPermission('branch.create')
                            ? [
                                FilledButton.icon(
                                  onPressed: () => Navigator.of(context)
                                      .pushNamed('/settings/branches/create'),
                  ...
                  if (items.isEmpty)
                    const SliverFillRemaining(
                      hasScrollBody: false,
                      child: _Message(message: 'No branches found.'),
                    )
                  else
                    SliverPadding(
