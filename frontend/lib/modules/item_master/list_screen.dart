...
class _ItemMasterListScreenState extends State<ItemMasterListScreen> {
                            ...
                            rows: svc.items.map((item) {
                              return DataRow(
                                cells: [
                                  ...
                                  DataCell(
                                    Text(item['unitOfMeasure'] as String),
                                  ),
                                  DataCell(
                                    Text(
                                      (item['salesEligible'] as bool)
                                          ? 'Eligible'
                                          : 'Excluded',
                                    ),
                                  ),
                        ...
                        children: [
                          IconButton(
                            onPressed: svc.page > 1
                                ? () => svc.fetchItems(page: svc.page - 1)
                                : null,
  ...
  Future<void> _showEditor(
    ...
    final unit = TextEditingController(
      text: item?['unitOfMeasure'] as String? ?? 'EA',
    );
