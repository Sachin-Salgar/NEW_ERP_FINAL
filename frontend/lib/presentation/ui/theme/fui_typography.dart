...
/// Light implementation using sensible defaults. Colors are left to the app theme.
class FUITypographyThemeLight extends FUITypographyTheme {
  @override
  TextStyle get defaultTextStyle => const TextStyle(
    // fontFamily intentionally left as a hint; actual font files must be added in pubspec.yaml if desired
