...
class AppTheme {
  ...
  static ThemeData _buildTheme(Brightness brightness) {
    ...
    final textTheme = _poppins
        .apply(
          bodyColor: colorScheme.onSurface,
          displayColor: colorScheme.onSurface,
        )
        .copyWith(
          displayLarge: _poppins.displayLarge?.copyWith(
            fontWeight: FontWeight.w600,
            color: colorScheme.onSurface,
          ),
          displayMedium: _poppins.displayMedium?.copyWith(
            fontWeight: FontWeight.w600,
            color: colorScheme.onSurface,
          ),
          displaySmall: _poppins.displaySmall?.copyWith(
            fontWeight: FontWeight.w600,
            color: colorScheme.onSurface,
          ),
          headlineLarge: _poppins.headlineLarge?.copyWith(
            fontWeight: FontWeight.w600,
            color: colorScheme.onSurface,
          ),
          headlineMedium: _poppins.headlineMedium?.copyWith(
            fontWeight: FontWeight.w600,
            color: colorScheme.onSurface,
          ),
          headlineSmall: _poppins.headlineSmall?.copyWith(
            fontWeight: FontWeight.w600,
            color: colorScheme.onSurface,
          ),
          ...
          titleMedium: _poppins.titleMedium?.copyWith(
            fontWeight: FontWeight.w600,
            color: colorScheme.onSurface,
          ),
          titleSmall: _poppins.titleSmall?.copyWith(
          ...
          bodySmall: _poppins.bodySmall?.copyWith(
            color: colorScheme.onSurfaceVariant,
          ),
          labelLarge: _poppins.labelLarge?.copyWith(
            color: colorScheme.onSurface,
          ),
          labelMedium: _poppins.labelMedium?.copyWith(
            color: colorScheme.onSurfaceVariant,
          ),
          labelSmall: _poppins.labelSmall?.copyWith(
            color: colorScheme.onSurfaceVariant,
          ),
        );
    ...
    return ThemeData(
      ...
      cardTheme: CardThemeData(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(
            color: dark ? const Color(0xFF41465A) : const Color(0xFFE5E9F0),
          ),
        ),
      ),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        border: OutlineInputBorder(
          ...
          borderSide: BorderSide(
            color: dark ? const Color(0xFF50566A) : const Color(0xFFD7DCE5),
          ),
        ),
