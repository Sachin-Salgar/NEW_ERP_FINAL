...
void main() {
  test('defines the Sales quotation route contract', () {
    ...
    expect(
      AppRoutes.routePermissions['/sales/quotations/create'],
      'sales.quotation.create',
    );
    expect(
      AppRoutes.routePermissions['/sales/quotations/details'],
      'sales.quotation.read',
    );
    expect(
      AppRoutes.routePermissions['/sales/quotations/edit'],
  ...
  test('normalizes and canonicalizes Sales quotation deep links', () {
    ...
    expect(
      AppRoutes.canonicalTopLevel('/sales/quotations/create'),
      '/sales/quotations',
    );
    expect(
      AppRoutes.salesQuotations.matches('/sales/quotations/details'),
      isTrue,
    );
  });
}
